...
MissileBullet::MissileBullet(Engine::Point position, Engine::Point forwardDirection, float rotation) :
	Bullet("play/bullet-3.png", 100, 4, position, forwardDirection, rotation + ALLEGRO_PI / 2) {
}
